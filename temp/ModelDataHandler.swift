...
////        }
//
//        var normalized_buffer = pixelBuffer.normalized(inputWidth, inputHeight)! as [Float32]
//
//        guard let outputs = inferencer.module.detect(image: &normalized_buffer) else {
//            return nil
//        }
//        print(outputs.count)
//        let resultArray2 = formatResults(
//            outputs: outputs,
//            width: CGFloat(imageWidth / 640),
//            height: CGFloat(imageWidth / 640)
//        )
//        // Returns the inference time and inferences
//        let result2 = Result(inferenceTime: 0.0, inferences: resultArray2)
//        print(result2)
//        return result2
